        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-8 items-center">
          <div className="flex justify-center md:justify-end">
            <div className="relative w-64 h-64 md:w-80 md:h-80 animate-float">
              <div className="w-full h-full rounded-full bg-gradient-to-tr from-primary to-primary/50 opacity-75"></div>
              <div className="absolute inset-4 rounded-full bg-secondary overflow-hidden border-4 border-background">
                <img 
