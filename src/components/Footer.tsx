...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="py-8 border-t border-border bg-secondary text-white">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            ...
            <a href="#skills" className="text-sm text-gray-400 hover:text-primary transition-colors">
              Skills
            </a>
        ...
        <div className="mt-8 border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0 text-sm text-gray-400">
            <span className="mr-2">
              Made with <span className="text-primary">❤</span> in Pune, India
            </span>
          </div>
        </div>
      </div>
